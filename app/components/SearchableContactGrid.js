                                            ...
                                            >
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        <div className={`h-5 w-5 rounded border flex items-center justify-center transition-all ${selectedIds.has(contact.id) ? 'bg-[#5e52ff] border-[#5e52ff] text-white' : 'border-white/10 text-transparent'
                                                            }`}>
